...
def hse_get_kpt_coordinate(filename = "KPOINTS"):
    ...
    for i in range(0, num_high_k):
        high_k_coordinate[i][0] = high_k_coordinates[i][0] * get_reciprocal()[0] + high_k_coordinates[i][1] * \
                                  get_reciprocal()[3] + high_k_coordinates[i][2]*get_reciprocal()[6]
        high_k_coordinate[i][1] = high_k_coordinates[i][0] * get_reciprocal()[1] + high_k_coordinates[i][1] * \
                                  get_reciprocal()[4] + high_k_coordinates[i][2]*get_reciprocal()[7]
        high_k_coordinate[i][2] = high_k_coordinates[i][0] * get_reciprocal()[2] + high_k_coordinates[i][1] * \
                                  get_reciprocal()[5] + high_k_coordinates[i][2]*get_reciprocal()[8]
...
def hse_bandplot(eng_r = [-10, 6, 2], color_noispin = "black", color_ispin = "red"):
    hse_output_band()
    ispin = get_ispin()
    num_kpt, length, high_kpt_point, kpt = get_kpt("KPATH.in")
...
def main():
    ...
    print("(1) band " + "\t" + "(2) HSE06 band plot ")
    print("(3) DOS  " + "\t" + "(4) Projected band plot ")
